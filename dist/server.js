...
Promise.resolve(new SoakpServer_1.SoakpServer(configs_1.default).start()).then(() => {
    console.log(`Started Secure OpenAI Key Proxy with TLS on port ${configs_1.default.sslPort}.
